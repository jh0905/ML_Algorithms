...
"""
 ...
 4.摘抄xgboost原论文的总结：
    在本文中，我们描述了我们在构建XGBoost时获得的经验教训，Xgboost是一个可扩展的树提升系统，被数据科学家广泛使用，并在许多问题上提供最新的
 结果。我们提出了一种处理稀疏数据的新稀疏感知算法和一个近似学习的理论上合理的加权分位数草图。我们的经验表明，缓存访问模式、数据压缩和分片是构建
 可扩展的端到端树提升系统的基本要素。这些问题也可以应用于其他机器学习系统。通过结合这些见解，XGBoost能够用最少的资源解决现实世界的规模问题.
"""
